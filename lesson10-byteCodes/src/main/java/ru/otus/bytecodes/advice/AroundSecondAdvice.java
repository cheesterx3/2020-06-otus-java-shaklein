...
public class AroundSecondAdvice implements Advice {

    @Override
    public Object invokeAround(JoinPoint point, Supplier<Object> executor) {
        System.out.println("****** AROUND SECOND before execute");
        Object retVal = executor.get();
        System.out.println("****** AROUND SECOND after execute. Value is " + retVal);
